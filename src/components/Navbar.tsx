  ...
  return (
    <div className="bg-white">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 shadow-lg">
        <nav className="relative px-4 py-4 flex justify-between items-center bg-gradient-to-r from-red-900 to-black">
          {/* Logo */}
          <button
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <>
            {/* Backdrop */}
            <motion.div
              className="navbar-backdrop fixed inset-0 bg-red-800 opacity-50 z-40"
              onClick={toggleMenu}
            ...
            {/* Mobile Menu */}
            <motion.nav
              className="fixed top-0 left-0 bottom-0 flex flex-col w-full max-w-sm py-6 px-6 bg-red-900 border-r overflow-y-auto z-50"
      ...
      {/* Desktop Carousel */}
      <div className="pt-16 mt-10 hidden md:block lg:block bg-gradient-to-b from-red-900 to-black">
        <div className="flex justify-center items-center w-full h-[400px]">
          <div className="relative w-full max-w-[800px] h-[400px]">
            <motion.img
              src="images/desktopimage.webp"
              alt="desktop"
      ...
      {/* Mobile Carousel */}
      <div className="pt-16 bg-gradient-to-b from-red-900 to-black lg:hidden md:hidden mt-10 mb-10">
        <Carousel
          showThumbs={false}
          infiniteLoop={true}
          autoPlay={true}
        ...
        >
          {/* Slide 1 */}
          <div className="relative w-full h-[300px] sm:h-[400px] flex justify-center items-center overflow-hidden">
            <motion.img
              src="images/caursole1.webp"
              alt="Slide 1"
